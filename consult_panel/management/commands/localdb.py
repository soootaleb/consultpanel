...
DEFAULT_CONTAINER_HOSTNAME = "cpanel_db"
DEFAULT_CONTAINER_NAME = "cpanel_db"
...
class Command(BaseCommand):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.image_name = "{}:{}".format(DEFAULT_IMAGE_NAME, DEFAULT_IMAGE_VERSION)
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stderr.write("Failed to lunch a databse container. The port %d might be used by an other container."
                              % DEFAULT_CONTAINER_PORT)
        except Exception as ex:
            self.stderr.write("Failed to lunch a databse container. An exception as occured.\n %s" % ex)
